...
# CSV file Open
def csv_file():
    with open('America\'s Largest Private Companies.csv','w') as csvfile:
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
        writer.writeheader()
    
# CSV file write row
def save_to_csv(data):
    with open('America\'s Largest Private Companies.csv', 'a') as csvfile:
...
url = "https://www.forbes.com/largest-private-companies/list/100/"
forbes.get(url)
time.sleep(10)
# Open CSV file
csv_file()
